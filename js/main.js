// Constants
    ...
    function showToast(message, type = 'success') {
      ...
      toast.style.cssText = `border-radius:0.75rem;padding:1rem;display:flex;align-items:center;justify-content:space-between;box-shadow:0 10px 30px rgba(0,0,0,0.4);pointer-events:auto;transform:translateY(-20px);opacity:0;transition:all 0.3s;border:1px solid ${
